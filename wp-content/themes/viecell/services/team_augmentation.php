...
<?php while ( have_rows('team_augmentation_sections') ) : the_row();?>
   <?php  if( get_row_layout() == 'bridge_resource_section' ) :?>
   <?php
   $bridge_resource_image = get_sub_field('bridge_resource_image');
   $bridge_resource_title = get_sub_field('bridge_resource_title');
   $bridge_resource_content = get_sub_field('bridge_resource_content');
   ?>
    ...
    <div id="process" class="work-process-area ">
        <div class="container">
            <div class="row pb-70">
                <div class="col-md-6">
                    <img src="<?php echo $bridge_resource_image; ?>" >
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 mobile-app-develop">
                     <div id="annual" class="tab-pane">
                        <div class="site-heading text-center">
                           <h2><?php echo $bridge_resource_title; ?></h2>
                        </div>
                        <?php echo $bridge_resource_content; ?>
                     </div>
                  </div>
            </div>
        </div>
